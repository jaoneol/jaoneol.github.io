...
## *Change the default path of WSL2*
...
PS D:\> cd .\01.WSL2\
PS D:\01.WSL2> git clone https://github.com/pxlrbt/move-wsl.git
...
PS D:\01.WSL2> cd .\move-wsl\
PS D:\01.WSL2\move-wsl> .\move-wsl.ps1
.\move-wsl.ps1 : 이 시스템에서 스크립트를 실행할 수 없으므로 D:\01.WSL2\move-wsl\move-wsl.ps1 파일을 로드할 수 없습니다
...
PS D:\01.WSL2\move-wsl> Set-ExecutionPolicy Unrestricted
```
...
d:\01.WSL2
Move Ubuntu to "d:\01.WSL2"? (Y|n): Y
Exporting VHDX to "d:\01.WSL2\Ubuntu.tar" ...
내보내기가 진행 중입니다. 이 작업은 몇 분 정도 걸릴 수 있습니다.
작업을 완료했습니다.
Unregistering WSL ...
Importing Ubuntu from d:\01.WSL2...
가져오기가 진행 중입니다. 이 작업은 몇 분 정도 걸릴 수 있습니다.
작업을 완료했습니다.
Cleaning up ...
Done!
PS D:\01.WSL2\move-wsl>
```

![Change the default path of WSL2](/assets/img/2025-01-27-Docker1_7.png)
_Change the default path of WSL2_
 ...
 * Support:        https://ubuntu.com/pro
 ...
 System information as of Sun Feb  2 01:25:32 KST 2025

  System load:  0.0                 Processes:             74
  Usage of /:   0.2% of 1006.85GB   Users logged in:       0
  Memory usage: 1%                  IPv4 address for eth0: 192.168.73.128
  Swap usage:   0%
